...
class MinMaxScaler(torch.nn.Module):
    ...
    ----------
        ...
        feature_range: tuple, defulat = (1, 0)
            The range of the output data. Default is (0, 1).
    """
    def __init__(self, dim: int, feature_range: tuple =(0, 1)):
        super().__init__()
    ...
    def fit(self, X):
        ...
        self.range = (self.feature_range[1] - self.feature_range[0]) / (self.max - self.min)
